  ...
  return (
    ...
    >
      <div className="text-center pt-2 w-full mx-auto">
        <h1 className="text-xl sm:text-2xl font-black text-[#000666] tracking-tight mb-2">
      ...
      <form id="login-form" noValidate onSubmit={handleLoginSubmit} className="space-y-4 w-full mx-auto">
        ...
        <button
          ...
          className="w-full mt-2 py-3.5 px-6 bg-[#000666] hover:bg-[#000444] active:scale-[0.99] text-white rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 border-0 shadow-md cursor-pointer"
        >
        ...
        <div className="text-center pt-2">
          <p className="text-xs font-medium text-slate-500">
            ...
            <button
              ...
              className="text-[#000666] hover:underline font-bold bg-transparent border-0 p-0 cursor-pointer ml-1"
            >
