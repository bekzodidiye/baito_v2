...
import { ArrowLeft, AlertCircle, Copy, RefreshCw, LayoutDashboard, Check } from 'lucide-react';
        ...
        >
          ...
          <div className="pt-10 pb-8 flex flex-col items-center text-center px-6">
            <motion.div 
              ...
              className="w-20 h-20 rounded-full bg-error-container flex items-center justify-center mb-4"
            >
              <AlertCircle className="w-12 h-12 text-error" />
            </motion.div>
            <h2 className="text-headline-md font-bold text-on-surface mb-1">To'lov amalga oshmadi</h2>
            <p className="text-body-md text-on-surface-variant max-w-[240px]">Tranzaksiya jarayonida xatolik yuz berdi</p>
          </div>
          ...
          <div className="py-6 px-6 text-center bg-surface-container-low/50">
            ...
            <p className="text-display font-extrabold text-error">2,450,000 UZS</p>
          </div>
          ...
          <div className="px-6 py-6 space-y-5">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="flex justify-between items-center">
              ...
              <motion.span 
                animate={{ boxShadow: ['0 0 0 0 rgba(186, 26, 26, 0.4)', '0 0 0 6px rgba(186, 26, 26, 0)', '0 0 0 0 rgba(186, 26, 26, 0)'] }}
                transition={{ duration: 2, repeat: Infinity }}
                className="px-3 py-1 rounded-full bg-error-container text-error text-label-lg font-bold"
              >
                Muvaffaqiyatsiz
              </motion.span>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="flex justify-between items-center">
              <span className="text-body-md text-on-surface-variant font-medium">Xatolik sababi</span>
              <span className="text-body-md text-error font-semibold text-right">Mablag' yetarli emas</span>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }} className="flex justify-between items-center">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }} className="h-[1px] bg-outline-variant/30 w-full"></motion.div>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }} className="flex justify-between items-center">
          ...
          {/* Bottom Support Text */}
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.0 }} className="px-6 pb-6 text-center">
