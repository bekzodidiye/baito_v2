...
export const LoginView: React.FC<LoginViewProps> = ({
  ...
  return (
    <motion.div
      ...
      className="space-y-5"
    >
      <div className="text-center pt-1 w-full mx-auto">
        <h1 className="text-xl sm:text-2xl font-black text-brand-primary tracking-tight mb-1.5">
      ...
      <form id="login-form" noValidate onSubmit={handleLoginSubmit} className="space-y-3.5 w-full mx-auto">
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-white border border-slate-200/80 hover:border-slate-300 rounded-xl py-2.5 pl-11 pr-4 text-xs font-semibold focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:outline-none transition-all placeholder:text-slate-350 shadow-3xs text-slate-755"
            />
          </div>
        </div>
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-white border border-slate-200/80 hover:border-slate-300 rounded-xl py-2.5 pl-11 pr-11 text-xs font-semibold focus:border-brand-primary focus:ring-1 focus:ring-brand-primary focus:outline-none transition-all placeholder:text-slate-350 shadow-3xs text-slate-755"
            />
            <button
              type="button"
        ...
        <button
          ...
          className="w-full mt-2 py-3 px-6 bg-brand-primary hover:bg-brand-primary/95 active:scale-[0.98] text-white rounded-[16px] text-xs font-bold transition-all flex items-center justify-center gap-1.5 border-0 shadow-lg shadow-brand-primary/20 cursor-pointer"
        >
